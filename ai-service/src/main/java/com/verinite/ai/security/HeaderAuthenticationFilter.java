package com.verinite.ai.security;
...
/**
 * Reads X-Auth-* headers injected by the API Gateway's JwtAuthFilter
 * and populates the Spring Security context so @PreAuthorize works.
 */
