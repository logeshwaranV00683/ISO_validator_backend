...
/**
 * Reads X-Auth-* headers injected by the API Gateway's JwtAuthFilter and
...
public class HeaderAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest  request,
        ...
        if (username != null && role != null) {
            ...
            // Stash raw header values for UserContext to read
    ...
    /** Carries the raw header values through the security context. */
